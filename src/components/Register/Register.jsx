    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      ...
      >
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 rounded-md">
          <div>
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-32 mx-auto text-cyan-500 drop-shadow-[0-35px_30px]"
            >
              <path
                strokeLinecap="round"
            ...
            <div className="w-full flex-1 mt-8">
              <div className="flex flex-col items-center">
                <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
                  ...
                  <span data-aos="zoom-in" className="ml-4">Sign Up with Google</span>
                </button>
                ...
                <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                  ...
                  <span data-aos="zoom-in" className="ml-4">Sign Up with GitHub</span>
                </button>
              </div>
              ...
              <div className="mx-auto max-w-xs">
                ...
                <button className="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                  ...
                  <span data-aos="zoom-in" className="ml-3">
                    Sign Up
                  </span>
                </button>
        ...
        <div className="flex-1  bg-indigo-100 text-center hidden lg:flex">
          <div data-aos="flip-right" className="bgi2 w-full"></div>
        </div>
      </div>
    </div>
  );
